...
function NEVERLOSE:AddWindow(NameScriptHub,Text,theme,UICustomSize)
	...
	if theme == "dark" then
		NEVERLOSE.Themes.BlackgroundColor = Color3.fromRGB(16, 16, 16)
	...
	local ooldsize=UICustomSize or UDim2.new(0.4300000003, 0, 0.8200000003, 0)
	local Tabs={}
...
imageLabel_6f.Image = "http://www.roblox.com/asset/?id=7999984136"
			...
			function sectionfunc:AddToggle(ToggleName,Default,callback)
				...
				local function toggleval(val,timea)
					if val then
						...
						TweenService:Create(Effect,TweenInfo.new(timea),{BackgroundColor3 = Color3.fromRGB(12, 18, 50)}):Play();
					else
